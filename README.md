...
This implementation starts from the work of dazanzan https://github.com/dazanza/copper-mcp and has evolved using vibe coding to provide a richer feature set:
...
## Running as SSE (Streaming tramite HTTP)
